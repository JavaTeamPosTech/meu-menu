...
@Schema(description = "DTO para requisição de atualização de Restaurante")
public record AtualizarRestauranteRequestDTO(
        @Schema(description = "CNPJ do restaurante (apenas números)", example = "00000000003300")
    ...
    public AtualizarRestauranteInputModel toInputModel(UUID proprietarioId) {
        ...
        return new AtualizarRestauranteInputModel(
                proprietarioId,
                cnpj,
                razaoSocial,
                nomeFantasia,
